...
Deste gráfico é possível retirar várias conclusões distintas. Primeiro, o número total de alugueres cresceu consideravelmente de 2011 para 2012. Todos os mêses de 2012 têm um número de alugueres superior ao mês correspondente em 2011, sendo até que mêses como Janeiro, Fevereiro e Março, duplicaram o número de bicicletas alugadas de um ano para o outro. 
Em relação à temperatura média dos mêses para cada um dos anos, como seria de esperar, cresce ao longo ao mêses, tendo o seu pico em Julho, a partir do qual começa a decrescer. Os valores médios de cada mês são quase idênticos nos 2 anos, com a excepção apenas dos mêses Janeiro e Março. 

<!-- o crescimento ao longo dos meses foi muito mais pronunciado em 2011... -->
