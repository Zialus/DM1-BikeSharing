...
De seguida, foram efetuados vários testes para verificar se os valores de certas variáveis estavam corretos. Também foram criadas várias colunas novas e os valores de certas variáveis foram modificados, com o objetivo de tornar a interpretação e análise dos dados mais legível. 
